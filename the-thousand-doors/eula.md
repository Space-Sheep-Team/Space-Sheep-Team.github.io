...
Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using The Thousand Doors.
...
- "**Agreement**" means this End-User License Agreement that forms the entire agreement between You and the Company regarding the use of the Application. This EULA was generated by [TermsFeed EULA Generator](https://www.termsfeed.com/eula-generator/).

- "**Application**" means the software program provided by the Company downloaded by You through an Application Store's account to a Device, named The Thousand Doors
...
- "**Company**" (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Space Sheep Team
...
- By visiting this page on our website: space-sheep-team.github.io
- By sending us an email: daniele.regecambrin@gmail.com
